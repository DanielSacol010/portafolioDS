...
const ProjectViews = lazy(() => import('./components/sections/ProjectViews'));
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Layout>
        ...
        <Suspense fallback={<LoadingFallback>Loading about...</LoadingFallback>}>
          <About />
        </Suspense>
        ...
        <Suspense fallback={<LoadingFallback>Loading project views...</LoadingFallback>}>
          <ProjectViews />
        </Suspense>
