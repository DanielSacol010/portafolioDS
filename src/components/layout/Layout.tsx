  ...
  return (
    <LayoutWrapper>
        ...
        <Nav role="navigation" aria-label="Main navigation">
          <div className="container">
            ...
            <NavLinks role="list">
              ...
              <a href="#education" role="listitem" aria-label="Education section">Formación</a>
              <a href="#project-views" role="listitem" aria-label="Project Views section">Vistas</a>
      ...
      <Footer role="contentinfo">
        <div className="container">
          <p>© {new Date().getFullYear()} Daniel Sacol. Todos los derechos reservados.</p>
        </div>
      </Footer>
    </LayoutWrapper>
  );
