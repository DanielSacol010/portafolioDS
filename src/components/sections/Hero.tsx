        ...
        <HeroContent>
          <div>
            <Title role="heading" aria-level={2}>
              Hola, soy Daniel Sacol
            </Title>
            <Subtitle role="heading" aria-level={3}>
              Desarrollador Web
            </Subtitle>
            <Description role="paragraph">
              !Bienvenidos a mi portafolio! Aquí encontrarás una selección de mis proyectos más destacados, 
              donde he aplicado mis habilidades en desarrollo web para crear experiencias únicas y funcionales. 
              Explora mis trabajos y descubre cómo puedo ayudarte a llevar tu próximo proyecto al siguiente nivel.
            </Description>
